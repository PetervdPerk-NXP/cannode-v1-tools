...
class DemoApplication:
    def __init__(self):
        ...
        self._sub_temperature = self._node.presentation.make_subscriber(uavcan.primitive.String_1_0, 1234)
    ...
    async def _handle_string(self,
                                  msg:      uavcan.primitive.String_1_0,
        ...
        """
        print('String: ', msg.value.tostring())
